...
class KerykeionLanguageCelestialPointModel(CustomBaseModel):
    ...
    True_Node: str = Field(title="True Node", description="The name of True Nsode in the chart, in the language")
    ...
    ASC: str = Field(title="ASC", description="The name of Ascendant in the chart, in the language")
